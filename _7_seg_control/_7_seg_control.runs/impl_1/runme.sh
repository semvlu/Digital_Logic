...
HD_PWD='C:/Users/User/Desktop/_7_seg_control/_7_seg_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log _7_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source _7_seg.tcl -notrace
