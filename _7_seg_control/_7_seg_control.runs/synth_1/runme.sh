...
HD_PWD='C:/Users/User/Desktop/_7_seg_control/_7_seg_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log _7_seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source _7_seg.tcl
